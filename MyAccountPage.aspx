<%@ Page Language="C#" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeFile="MyAccountPage.aspx.cs" Inherits="MyAccountPage" %>
            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="active"><asp:HyperLink ID="hyperLink_myAccount" runat="server" NavigateUrl="~/MyAccountPage.aspx">My Account</asp:HyperLink></li>                      
                    ...
                    <div class="text-center">
                         <table class="table-responsive" style="margin-right:auto;margin-left:auto">
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="tbUserId" runat="server" CssClass="form-control" placeholder="First Name" ></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="lbUpdateMsg" runat="server" ForeColor="Green"></asp:Label>                 
                                            </td>
                                            <td>
                                                <asp:Button ID="btMyAccountUpdate" runat="server" CssClass="btn btn-success" Text="Update" OnClick="btMyAccountUpdate_Click" />
                                            </td>
                                        </tr>
                        </table>
                    </div>
                    ...
                    <div class="text-center">
                        ...
                        <table class="table-responsive" style="margin-right:auto; margin-left:auto">
                            ...
                            <tr>
                                <td>&nbsp;</td>
                                <td>
                                    <asp:Button ID="btClassRegister" runat="server" CssClass="btn btn-success" Text="Register" OnClick="btClassRegister_Click" />
                                </td>
                            </tr>
                        </table>
